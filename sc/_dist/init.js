...
function everyPageLoad()
{
    ...
    $(".js-show").each(function(){
        ...
        $(this).append('<input type="button" class="js-button" value="Copy" data-clipboard-text="' + htmlspecialchars(sourceCode) +'" />');
    });

    // 程式碼上色
    $('.js-show code').each(function(i, block) {
